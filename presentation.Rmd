...
When you are stuck in front of a computer without internet access, 
how you get some data out, play with it and gain some insights.  
...
Fit a model to determine which day of week would be best to avoid delay.
